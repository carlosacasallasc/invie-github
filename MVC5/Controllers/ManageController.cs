    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.AddPhoneSuccess ? "Su número telfónico ha sido agredado."
                : message == ManageMessageId.RemovePhoneSuccess ? "Su número de teléfono ha sido eliminado."
                : "";
